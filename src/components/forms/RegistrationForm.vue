<template>
    <form @submit.prevent="onSubmit">
        ...
        <label class="mb-6 flex items-center text-[12px] text-black">
            ...
            <div>
                я согласен с условиями <router-link :to="{name: 'privacy-policy'}" class="underline hover:no-underline">политики конфиденциальности</router-link>
            </div>
        </label>
        <div class="mb-12 flex items-center gap-7"> 
            <button type="submit" class="app-button app-button--secondary">Зарегистрироваться</button>
        </div>
    </form>
</template>
